        ...
        <div class="col-lg-8 col-md-8">
            <div class="ibox">
                <div class="ibox-head bg-ebony-400 text-white">
                    <div class="ibox-title">Ubah Data Karyawan</div>
                ...
                <div class="ibox-body">
                    <form method="POST" action="<?= site_url('karyawan/' . $nik) ?>">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input class="form-control" type="text" value="<?= $data['nama_lengkap'] ?>" name="nama">
                            </div>
                            <div class="col-sm-6 form-group">
                                <label>&nbsp;</label>
                                <div class="form-group">
                                    <label class="ui-checkbox ui-checkbox-success">
                                        <input type="radio" name="gender" value="L" <?= ($data['gender'] == "L") ? "checked" : ""; ?>>
                                        <span class="input-span"></span>Laki-Laki
                                    </label>
                                    <label class="ui-checkbox ui-checkbox-success ml-3">
                                        <input type="radio" name="gender" value="P" <?= ($data['gender'] == "P") ? "checked" : ""; ?>>
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input class="form-control" type="text" value="<?= $data['tempat_lahir'] ?>" name="t_lahir">
                            </div>
                            <div class="col-sm-6 form-group">
