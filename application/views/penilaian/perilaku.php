...
<div class="page-content fade-in-up">
        ...
        <div class="col-lg">
            <div class="ibox">
                ...
                <div class="ibox-body">
                    ...
                    <form method="POST" action="<?= site_url('penilaian/perilaku') ?>">
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-2">
                                <input type="number" id="kebersihan" class="form-control" step="0.01" value="00.000" placeholder="00.000" name="kebersihan">
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-2">
                                <input type="number" id="peraturan" class="form-control" step="0.01" value="00.000" placeholder="00.000" name="peraturan">
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-2">
                                <input type="number" id="kejujuran" class="form-control" step="0.01" value="00.000" placeholder="00.000" name="kejujuran">
                                <small>maks. 30 poin</small>
                            </div>
                        </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg">
            <div class="ibox">
                <div class="ibox-head bg-ebony-400 text-white">
                    <div class="ibox-title">Data Penilaian Karyawan : PERILAKU</div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= date('d F Y', strtotime($d['tgl_penilaian_perilaku'])) ?></td>
                                    <td class="text-center"><?= number_format($d['kebersihan'], 2, ",", ".") ?></td>
                                    <td class="text-center"><?= number_format($d['peraturan'], 2, ",", ".") ?></td>
                                    <td class="text-center"><?= number_format($d['kejujuran'], 2, ",", ".") ?></td>
                                    <td class="text-center"><?= number_format($d['komunikasi'], 2, ",", ".") ?></td>
                                    <td class="text-center"><?= number_format($d['total_poin_perilaku'], 2, ",", ".") ?></td>
                                    <td><?= $d['keterangan_perilaku'] ?></td>
                                    <td class="text-center">
                                        <a href="<?= site_url('penilaian/perilaku/' . $d['nik']) ?>" class="btn btn-warning">
