...
<div class="page-content fade-in-up">
        ...
        <div class="col-lg">
            <div class="ibox">
                ...
                <div class="ibox-body">
                    ...
                    <form method="POST" action="<?= site_url('penilaian/kedisiplinan') ?>">
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-2">
                                <input type="number" id="total_hari" class="form-control" step="0.01" value="00.00" placeholder="0.00" name="total_hari">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-2">
                                <input type="number" id="total_masuk" class="form-control" step="0.01" value="00.00" placeholder="0.00" name="total_masuk">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-2">
                                <input type="number" id="kebersihan" class="form-control" step="0.01" value="00.00" placeholder="00.00" name="total_potongan">
                            </div>
                        </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg">
            <div class="ibox">
                <div class="ibox-head bg-ebony-400 text-white">
                    <div class="ibox-title">Data Penilaian Karyawan : KEDISIPLINAN</div>
                    ...
                    <table class="table table-striped table-hover" id="example" style="width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">TOTAL PEMOTONGAN POIN</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= date('d F Y', strtotime($d['tgl_penilaian_kedisiplinan'])) ?></td>
                                    <td class="text-center"><?= number_format($d['hari_kerja'], 2, ",", ".") ?></td>
                                    <td class="text-center"><?= number_format($d['total_masuk'], 2, ",", ".") ?></td>
                                    <td class="text-center"><?= number_format($d['total_potongan'], 2, ",", ".") ?></td>
                                    <td class="text-center"><?= number_format($d['total_poin_kedisiplinan'], 2, ",", ".") ?></td>
                                    <td><?= $d['keterangan_disiplin'] ?></td>
                                    <td class="text-center">
                                        <a href="<?= site_url('penilaian/kedisiplinan/' . $d['nik']) ?>" class="btn btn-warning">
