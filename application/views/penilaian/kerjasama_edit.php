        ...
        <div class="col-lg">
            <div class="ibox">
                ...
                <div class="ibox-body">
                    ...
                    <form method="POST" action="<?= site_url('penilaian/kerjasama/' . $data['nik']) ?>">
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-2">
                                <input type="hidden" name="idkerjasama" value="<?= $data['id_kerjasama'] ?>">
                                <input type="number" id="potongan" class="form-control" step="0.01" value="<?= $data['potongan'] ?>" placeholder="00.00" name="potongan">
                            </div>
                        </div>
                    ...
                    <div class="row" style="font-size: 20px; font-weight: bold;">
                        <div class="col-md-6">
                            Total Poin : <?= number_format($data['total_poin_kerjasama'], 2, ",", ".") ?>
                        </div>
                        <div class="col-md-6">
                            Keterangan : <?= $data['keterangan_kerjasama'] ?>
                        </div>
                    </div>
                </div>
            </div>
