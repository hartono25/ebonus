...
<div class="page-content fade-in-up">
        ...
        <div class="col-lg">
            <div class="ibox">
                ...
                <div class="ibox-body">
                    ...
                    <form method="POST" action="<?= site_url('penilaian/absensi') ?>">
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-2">
                                <input type="number" id="total_hari" class="form-control" type="number" step="0.01" value="00.00" placeholder="0.00" name="total_hari">
                            </div>
                        </div>
                        ...
                        <div class="row mb-5 align-items-center">
                            ...
                            <div class="col-2">
                                <input type="number" id="total_masuk" class="form-control" type="number" step="0.01" value="00.00" placeholder="0.00" name="total_masuk">
                            </div>
                        </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg">
            <div class="ibox">
                <div class="ibox-head bg-ebony-400 text-white">
                    <div class="ibox-title">Data Penilaian Karyawan : ABSENSI</div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= date('d F Y', strtotime($d['tgl_penilaian'])) ?></td>
                                    <td class="text-center"><?= number_format($d['total_poin'], 2, ",", ".") ?></td>
                                    <td><?= $d['keterangan'] ?></td>
                                    <td class="text-center">
                                        <a href="<?= site_url('penilaian/absensi/' . $d['nik']) ?>" class="btn btn-warning">
