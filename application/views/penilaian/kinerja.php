...
<div class="page-content fade-in-up">
        ...
        <div class="col-lg">
            <div class="ibox">
                ...
                <div class="ibox-body">
                    ...
                    <form method="POST" action="<?= site_url('penilaian/kinerja') ?>">
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-2">
                                <input type="number" id="komunikasi" class="form-control" step="0.01" value="00.000" placeholder="00.000" name="komunikasi">
                            ...
                            <div class="col-2">
                                <input type="number" id="target" class="form-control" step="0.01" value="00.000" placeholder="00.000" name="target">
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-2">
                                <input type="number" id="teknis" class="form-control" step="0.01" value="00.000" placeholder="00.000" name="teknis">
                            ...
                            <div class="col-2">
                                <input type="number" id="disiplin" class="form-control" step="0.01" value="00.000" placeholder="00.000" name="disiplin">
                                <small>maks. 10 poin</small>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-2">
                                <input type="number" id="kecepatan" class="form-control" step="0.01" value="00.000" placeholder="00.000" name="kecepatan">
                                <small>maks. 10 poin</small>
                            </div>
                            ...
                            <div class="col-2">
                                <input type="number" id="adaptasi" class="form-control" step="0.01" value="00.000" placeholder="00.000" name="adaptasi">
                                <small>maks. 10 poin</small>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-2">
                                <input type="number" id="waktu" class="form-control" step="0.01" value="00.000" placeholder="00.000" name="waktu">
                                <small>maks. 15 poin</small>
                            </div>
                        </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg">
            <div class="ibox">
                <div class="ibox-head bg-ebony-400 text-white">
                    <div class="ibox-title">Data Penilaian Karyawan : KINERJA</div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= date('d F Y', strtotime($d['tgl_penilaian_kinerja'])) ?></td>
                                    <td class="text-center"><?= number_format($d['total_poin_kinerja'], 2, ",", ".") ?></td>
                                    <td><?= $d['keterangan_kinerja'] ?></td>
                                    <td class="text-center">
                                        <a href="<?= site_url('penilaian/kinerja/' . $d['nik']) ?>" class="btn btn-warning">
