...
<div class="page-content fade-in-up">
        ...
        <div class="col-lg">
            <div class="ibox">
                <div class="ibox-head bg-ebony-400 text-white">
                    <div class="ibox-title">Form Penilaian Karyawan : KERJASAMA TIM</div>

                </div>
                <div class="ibox-body">

                    <form method="POST" action="<?= site_url('penilaian/kerjasama') ?>">
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-2">
                                <input type="number" id="potongan" class="form-control" step="0.01" value="00.00" placeholder="00.00" name="potongan">
                            </div>
                        </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg">
            <div class="ibox">
                <div class="ibox-head bg-ebony-400 text-white">
                    <div class="ibox-title">Data Penilaian Karyawan : KERJASAMA TIM</div>
                    ...
                    <table class="table table-striped table-hover" id="example" style="width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">PEMOTONGAN POIN</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= date('d F Y', strtotime($d['tgl_penilaian_kerjasama'])) ?></td>
                                    <td class="text-center"><?= number_format($d['potongan'], 2, ",", ".") ?></td>
                                    <td class="text-center"><?= number_format($d['total_poin_kerjasama'], 2, ",", ".") ?></td>
                                    <td><?= $d['keterangan_kerjasama'] ?></td>
                                    <td class="text-center">
                                        <a href="<?= site_url('penilaian/kerjasama/' . $d['nik']) ?>" class="btn btn-warning">
